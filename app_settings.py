...
CLEAR_REMINDERS_DAYSOFWEEK = getattr(settings, 'WORKLOG_CLEAR_REMINDERS_DAYSOFWEEK', [1,2,3,4,5])

# The time and says to send reminder emails.
SEND_REMINDERS_HOUR = getattr(settings, 'WORKLOG_SEND_REMINDERS_HOUR', 18)
SEND_REMINDERS_DAYSOFWEEK = getattr(settings, 'WORKLOG_SEND_REMINDERS_DAYSOFWEEK', [1,2,3,4,5])
