...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.do_not_invoice'
        db.add_column('worklog_job', 'do_not_invoice', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.do_not_invoice'
        db.delete_column('worklog_job', 'do_not_invoice')
