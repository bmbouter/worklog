...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BiweeklyEmployee.project_num'
        db.add_column('worklog_biweeklyemployee', 'project_num', self.gf('django.db.models.fields.CharField')(default='000000', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BiweeklyEmployee.project_num'
        db.delete_column('worklog_biweeklyemployee', 'project_num')
