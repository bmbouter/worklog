...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('worklog_workperiod', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('worklog', ['WorkPeriod'])

        # Adding model 'Holiday'
        db.create_table('worklog_holiday', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('worklog', ['Holiday'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('worklog_workperiod')

        # Deleting model 'Holiday'
        db.delete_table('worklog_holiday')
    ...
    models = {
        ...
        'worklog.employee': {
            ...
            'biweekly': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
