...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PayPeriod.work_period'
        db.add_column('worklog_payperiod', 'work_period', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['worklog.WorkPeriod']), keep_default=False)

        # Deleting field 'WorkPeriod.pay_period'
        db.delete_column('worklog_workperiod', 'pay_period_id')


    def backwards(self, orm):
        
        # Deleting field 'PayPeriod.work_period'
        db.delete_column('worklog_payperiod', 'work_period_id')

        # User chose to not deal with backwards NULL issues for 'WorkPeriod.pay_period'
        raise RuntimeError("Cannot reverse this migration. 'WorkPeriod.pay_period' and its values cannot be restored.")
    ...
    models = {
        ...
        'worklog.payperiod': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'work_period': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['worklog.WorkPeriod']"})
        },
        'worklog.workitem': {
