...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Holiday.description'
        db.add_column('worklog_holiday', 'description', self.gf('django.db.models.fields.CharField')(default=1, max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Holiday.description'
        db.delete_column('worklog_holiday', 'description')
